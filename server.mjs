...
.theme-btn:hover, .gh-btn:hover { color: var(--text); border-color: var(--accent); }
.card {
  width: 100%;
  max-width: 460px;
  background: var(--card-bg);
...
<body>
<div class="theme-bar">
  <a class="gh-btn" href="https://github.com/glwhappen/sms-relay" target="_blank" title="GitHub 开源仓库">
